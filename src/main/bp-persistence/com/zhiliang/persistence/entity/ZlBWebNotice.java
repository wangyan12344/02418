 ...
 * @author superma
 */
@Entity(name = "zl_b_webnotice")
public class ZlBWebNotice extends BaseEntity implements Serializable, Cloneable {

	private static final long serialVersionUID = 2771520336458455846L;
	
	public ZlBWebNotice clone() {
		ZlBWebNotice o = null;
		try {
			o = (ZlBWebNotice) super.clone();
