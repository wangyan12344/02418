 ...
 * @author 马骞
 */
@Component("ZlBAppNewsCategoryDAO")
public class ZlBAppNewsCategoryDAO extends BaseDao {
	...
	private JDBCHelper makeSearch(ZlBNewsCategory entiy, String sql) {
		...
		if (entiy != null) {
				...
				jdbcHelper.putOrder( " T.rootid +0 asc,T.ordernum+0  asc " );
	...
	public List<ZlBNewsCategory> getEntityNumByid(String id) {
		String sql="SELECT  *  FROM zl_b_news_category where parentid=? order by  ordernum+0 desc ";
