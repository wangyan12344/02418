...
<body>
    ...
    <div class="rightinfo">
    	<div class="tools">
	        ...
	        <!-- 查询条件form begin-->        
			  	<li><label>发布时间</label>
			 		<input type="text" class="dfinput datepicker" name="zlBDepartment.stime" id="stime" placeholder="始" dc="true" style="background-color: rgb(255, 255, 255);">
			 		<input type="text" class="dfinput datepicker" name="zlBDepartment.etime" id="etime" placeholder="末" dc="true" style="background-color: rgb(255, 255, 255);">
			 	</li>			
			<!-- 查询条件end -->   
	    	...
	    	<ul class="toolbar1">
	        <li><a href="<%=request.getContextPath() %>/ZlBDepartmentController/add.do" target="rightFrame"><span><img src="<%=request.getContextPath() %>/rapast/common/images/t01.png" /></span>添加</a></li>
	        </ul>
    	</div>
...
<script type="text/javascript" src="<%=request.getContextPath() %>/rapast/zhiliang/manager/ZlBDepartment/js/ZlBDepartment_list.js"></script>
</html>
