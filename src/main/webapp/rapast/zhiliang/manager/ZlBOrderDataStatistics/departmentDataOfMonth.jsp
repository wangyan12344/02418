...
.place{height:40px; background:url(../../rapast/common/images/righttop.gif) repeat-x;}
.place span{line-height:40px; font-weight:bold;float:left; margin-left:12px;}
.placeul li{float:left; line-height:40px; padding-left:7px; padding-right:12px; background:url(../../rapast/common/images/rlist.gif) no-repeat right;}
...
<body class="home_bg">
	<div class="place">
					...
					<div id="traderDistribute" style="width: 100%;height:500px; float: left;"></div>
    				 
				
</body>
<script type="text/javascript" src="<%=request.getContextPath() %>/rapast/zhiliang/manager/ZlBOrderDataStatistics/js/departmentDataOfMonth.js"></script>
</html>
