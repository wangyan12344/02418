...
<script type="text/javascript" src="<%=request.getContextPath() %>/rapast/index/js/branches.js"></script>
 ...
 <li onclick=gotonewsdetail("{{:newsid}}")><span>{{:publishtime}}</span><a href="javascript:void(0)"><img src="<%=request.getContextPath() %>/rapast/index/images/icon8.jpg" width="17" height="17" />{{:newstitle.substring(0,80)}}</a></li>
	</script>	
	<script type="text/javascript">
	var opid = '';
	var parentid='<%=request.getParameter("opid") %>';
	if(parentid=="" || parentid==null){
		 parentid='f20f3e6ec4c04003a04298f27b40a4d1';
		 
		 //f20f3e6ec4c04003a04298f27b40a4d1 网点信息
	}
