...
<script type="text/javascript" src="<%=request.getContextPath() %>/rapast/index/js/search.js"></script>
...
<script type="text/x-jsrender" id="dataListTemplate">
 ...
 <div class="nybox2_nr_1" onclick="gotonewsdetail('{{:newsid}}')"><img src="{{:mainimgpath}}" /><h2><b>{{:publishtime}}</b>{{:newstitle}}</h2><span>{{if newsintro.length>=94}}{{:newsintro.replace(newsintro.substr(94,newsintro.length),"...")}}{{else}}{{:newsintro}}{{/if}}</span><kbd><a href="javascript:gotonewsdetail('{{:newsid}}');">查看详细></a></kbd></div>
	...
	var newstitle = '<%=request.getParameter("newstitle") %>';
...
<div class="nybox2">
  ...
  <div class="nybox2_nr" >
   ...
   <%--  <div class="nybox2_nr_1"><img src="<%=request.getContextPath() %>/rapast/index/images/pic2.jpg" /><h2><b>2018-07-24 </b>葫芦岛银行新行徽新形象开启新征程</h2><span>7月19日，“刷新世界 耀启未来”葫芦岛银行品牌形象升级发布会暨公务卡首发仪式在体育馆隆重举行，更换新行徽、公务卡发售，标志着葫芦岛银行又以崭新的形象开启了新征程。著名演员、导演、制片人张国立受邀参加启动仪式。</span><kbd><a href="newsview.html">查看详细></a></kbd></div>
    <div class="nybox2_nr_1"><img src="<%=request.getContextPath() %>/rapast/index/images/pic2.jpg" /><h2><b>2018-07-24 </b>葫芦岛银行新行徽新形象开启新征程</h2><span>7月19日，“刷新世界 耀启未来”葫芦岛银行品牌形象升级发布会暨公务卡首发仪式在体育馆隆重举行，更换新行徽、公务卡发售，标志着葫芦岛银行又以崭新的形象开启了新征程。著名演员、导演、制片人张国立受邀参加启动仪式。</span><kbd><a href="newsview.html">查看详细></a></kbd></div>
    <div class="nybox2_nr_1"><h2><b>2018-07-24 </b>葫芦岛银行新行徽新形象开启新征程</h2><span>7月19日，“刷新世界 耀启未来”葫芦岛银行品牌形象升级发布会暨公务卡首发仪式在体育馆隆重举行，更换新行徽、公务卡发售，标志着葫芦岛银行又以崭新的形象开启了新征程。著名演员、导演、制片人张国立受邀参加启动仪式。</span><kbd><a href="newsview.html">查看详细></a></kbd></div>
    <div class="nybox2_nr_1"><h2><b>2018-07-24 </b>葫芦岛银行新行徽新形象开启新征程</h2><span>7月19日，“刷新世界 耀启未来”葫芦岛银行品牌形象升级发布会暨公务卡首发仪式在体育馆隆重举行，更换新行徽、公务卡发售，标志着葫芦岛银行又以崭新的形象开启了新征程。著名演员、导演、制片人张国立受邀参加启动仪式。</span><kbd><a href="newsview.html">查看详细></a></kbd></div>
    <div class="nybox2_nr_1"><h2><b>2018-07-24 </b>葫芦岛银行新行徽新形象开启新征程</h2><span>7月19日，“刷新世界 耀启未来”葫芦岛银行品牌形象升级发布会暨公务卡首发仪式在体育馆隆重举行，更换新行徽、公务卡发售，标志着葫芦岛银行又以崭新的形象开启了新征程。著名演员、导演、制片人张国立受邀参加启动仪式。</span><kbd><a href="newsview.html">查看详细></a></kbd></div>
   --%>
   <div class="pages" >
