...
<script type="text/javascript" src="<%=request.getContextPath() %>/rapast/index/js/leader.js"></script>
<script type="text/x-jsrender" id="categoryTemplate">
  ...
  <li   onclick="queryDataList('{{:categoryid}}','0','{{:categoryname}}')" id="{{:categoryid}}"><a href="javascript:void(0)">{{:categoryname}}</a></li>
   ...
   <dl onclick=gotonewsdetail("{{:newsid}}")><a href="javascript:void(0)">
        <dd><img src="{{:mainimgpath}}" width="400" height="280" /></dd>
        <dt>
          <h2>{{:newstitle.substring(0,24)}}  </h2>
          <span>{{:newsintro}}</span>
        </dt></a>
      </dl>
	...
	//var parentid='c4ec893a0c7f43039d2bd0ca644bb697';
</script>
<style>
/*分页*/
...
<div class="nybox2">
  <div class="nybox2_fl">
    ...
    <div class="nybox2_right1">
      ...
      <div class="nybox2_right5"  id="dataListId">
