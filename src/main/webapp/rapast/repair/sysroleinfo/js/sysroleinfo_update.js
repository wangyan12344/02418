...
function initPage(){
	$.ajax({
		url:getRequestUrl("/SysRoleInfoController/beforeUpdateEntity.json"),
		dataType:"json",
		data:{"sysRoleInfo.roleid":roleid},
...
function bindevent(){
	...
	$("#submitBtn").bind('click',function(){
		...
		if(checkfalg){
			...
			$.ajax({
				url:getRequestUrl("/SysRoleInfoController/updateEntityData.json"),
				dataType:"json",
				data:postData,
