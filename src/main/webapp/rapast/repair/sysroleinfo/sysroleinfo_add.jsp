...
<script type="text/x-jsrender" id="formTemplate">
    ...
    <ul class="forminfo">
    <li><label>角色名称</label><input name="sysRoleInfo.rolename" dcrequired="请输入角色名称" type="text" class="dfinput" value="" dc="" /></li>
    <li><label>角色权限</label>
		<div>
...
<script type="text/javascript" src="<%=request.getContextPath() %>/rapast/repair/sysroleinfo/js/sysroleinfo_add.js"></script>
</html>