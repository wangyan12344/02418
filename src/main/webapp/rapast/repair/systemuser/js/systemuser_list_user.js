...
function queryDataList(){
	...
	var parameterData = {
			url:getRequestUrl("/SysUserInfoController/queryDataListByUserid.json"),
...
function updateEntityDataFun(id){
	...
	var page = "/rapast/repair/systemuser/systemuser_update_user.jsp?userid="+id+"&pageIndex="+pageIndex;
	pageForward(page);
}
