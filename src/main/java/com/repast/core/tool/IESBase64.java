...
public static String decode(String data, String charset) throws Exception
{
    if (data == null || data.length() == 0)
        return data;
    return new String(IESBase64.decode(data), charset);
}

public static void main(String[] args) throws Exception
{
    String data = "2014年1月22日星期三   上海联合产权交易所 第一次客户演示 记录";
    String data1 = encode(data, "Unicode");
    System.out.println(data1);
    data1 = "//4yADAAMQA0AHReMQAIZzIAMgDlZR9mH2cJTiAAIAAgAApOd21UgAhUp05DZ6ROE2ZAYiAALHsATiFrols3YhRvOnkgALCLVV8=";
